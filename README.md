...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/chemml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13909&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/chemml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `chemml` can be installed with:

```
conda install chemml
```

It is possible to list all of the versions of `chemml` available on your platform with:
